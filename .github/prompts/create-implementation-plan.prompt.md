...
- **architect-reviewer** — Architecture and design validation
- **research-analyst** — Requirements and alternatives research
- Domain-specific agents for technology analysis (e.g., **java-architect**, **react-specialist**)
