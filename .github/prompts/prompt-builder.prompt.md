---
agent: 'agent'
tools: ['read/readFile', 'edit/editFiles', 'search', 'agent', 'doist/todoist-ai/search']
...
- **prompt-engineer** — Prompt optimization and best practices
- **documentation-engineer** — Markdown structure and formatting
- Domain-specific agents for technology-focused prompt sections
