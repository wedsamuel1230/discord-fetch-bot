...
tools: ['vscode/openSimpleBrowser', 'execute/testFailure', 'execute/getTerminalOutput', 'execute/runTask', 'execute/getTaskOutput', 'execute/createAndRunTask', 'execute/runInTerminal', 'read/readFile', 'read/terminalSelection', 'read/terminalLastCommand', 'edit', 'search', 'web', 'agent', 'doist/todoist-ai/fetch', 'doist/todoist-ai/search', 'todo']
---
...
- **search-specialist** — Repository scanning and pattern detection
- **research-analyst** — awesome-copilot analysis
- **documentation-engineer** — Output formatting
