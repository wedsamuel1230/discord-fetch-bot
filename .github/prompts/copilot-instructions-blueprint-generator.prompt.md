...
- **architect-reviewer** — Architecture pattern analysis
- **code-reviewer** — Code quality and pattern detection
- **documentation-engineer** — Blueprint structure and formatting
- Domain-specific agents (e.g., **react-specialist**, **java-architect**, **dotnet-core-expert**) for technology analysis
