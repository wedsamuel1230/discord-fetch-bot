...
github_url: https://github.com/trailofbits/testing-handbook
github_hash: a97b659c789dfd26d98620afbb1d9fcb4bc7e3fe
---
...
5. Run validator on the single skill: `uv run --no-project scripts/validate-skills.py --skill {skill-name}`
...
- [ ] Validator passes: `uv run --no-project scripts/validate-skills.py`
