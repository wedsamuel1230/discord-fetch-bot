...
uv run --no-project scripts/validate-skills.py

# Validate specific skill
uv run --no-project scripts/validate-skills.py --skill libfuzzer

# Output JSON for CI integration
uv run --no-project scripts/validate-skills.py --json

# Verbose output with details
uv run --no-project scripts/validate-skills.py -v
```
...
```bash
uv run --no-project scripts/validate-skills.py --skill [skill-name]
```
...
│  uv run --no-project scripts/validate-skills.py --skill [name]   │
│                                                     │
...
### Automated Validation
- [ ] Validator passes: `uv run --no-project scripts/validate-skills.py --skill [name]`
- [ ] No errors in output
...
uv run --no-project scripts/validate-skills.py --json > validation-report.json
