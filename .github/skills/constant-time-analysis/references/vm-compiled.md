...
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --warnings CryptoUtils.java

# Filter to specific methods
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --func 'sign|verify' CryptoUtils.java

# CI-friendly JSON output
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --json CryptoUtils.java
```
