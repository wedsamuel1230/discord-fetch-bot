...
```bash
# Analyze PHP file
uv run --no-project {baseDir}/ct_analyzer/analyzer.py crypto.php

# Include warning-level violations
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --warnings crypto.php

# Filter to specific functions
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --func 'encrypt|decrypt' crypto.php

# JSON output for CI
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --json crypto.php
```
