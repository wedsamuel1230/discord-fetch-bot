...
```bash
# Analyze Ruby file
uv run --no-project {baseDir}/ct_analyzer/analyzer.py crypto.rb

# Include warning-level violations
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --warnings crypto.rb

# Filter to specific functions
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --func 'encrypt|sign' crypto.rb

# JSON output for CI
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --json crypto.rb
```
