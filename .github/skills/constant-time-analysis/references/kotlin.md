...
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --warnings CryptoUtils.kt

# Filter to specific functions
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --func 'sign|verify' CryptoUtils.kt

# CI-friendly JSON output
uv run --no-project {baseDir}/ct_analyzer/analyzer.py --json CryptoUtils.kt
```
