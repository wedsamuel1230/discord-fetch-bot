...
allowed-tools:
  ...
  - Glob
  - Grep
github_url: https://github.com/microsoft/sarif-sdk
github_hash: 7109a23864d4e0b20ec9e120273bf3113040814e
---
...
| Python scripting (simple) | pysarif | `uv pip install pysarif` |
| Python scripting (advanced) | sarif-tools | `uv pip install sarif-tools` |
