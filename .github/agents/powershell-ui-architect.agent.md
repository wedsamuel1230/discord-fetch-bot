...
tools: ['vscode', 'execute', 'read', 'edit', 'search', 'brave-search-mcp-server/*', 'com.figma.mcp/mcp/*', 'doist/todoist-ai/search', 'io.github.upstash/context7/*', 'microsoftdocs/mcp/*', 'sequential-thinking/*', 'agent', 'todo']
---
